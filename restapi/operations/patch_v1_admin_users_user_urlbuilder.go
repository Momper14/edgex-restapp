...
func (o *PatchV1AdminUsersUserURL) WithBasePath(bp string) *PatchV1AdminUsersUserURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *PatchV1AdminUsersUserURL) Build() (*url.URL, error) {
	...
	if user != "" {
		...
		return nil, errors.New("user is required on PatchV1AdminUsersUserURL")
	}
...
func (o *PatchV1AdminUsersUserURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PatchV1AdminUsersUserURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PatchV1AdminUsersUserURL")
	}
