...
func (o *DeleteV1AdminUsersUserURL) WithBasePath(bp string) *DeleteV1AdminUsersUserURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *DeleteV1AdminUsersUserURL) Build() (*url.URL, error) {
	...
	var _path = "/v1/admin/users/{user}"

	user := o.User
	if user != "" {
		_path = strings.Replace(_path, "{user}", user, -1)
	} else {
		return nil, errors.New("user is required on DeleteV1AdminUsersUserURL")
	}
...
func (o *DeleteV1AdminUsersUserURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteV1AdminUsersUserURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteV1AdminUsersUserURL")
	}
