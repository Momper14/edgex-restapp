...
func (o *GetV1DevicesDeviceProfileURL) WithBasePath(bp string) *GetV1DevicesDeviceProfileURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetV1DevicesDeviceProfileURL) Build() (*url.URL, error) {
	...
	var _path = "/v1/devices/{device}/profile"

	device := o.Device
	if device != "" {
		_path = strings.Replace(_path, "{device}", device, -1)
	} else {
		return nil, errors.New("device is required on GetV1DevicesDeviceProfileURL")
	}
...
func (o *GetV1DevicesDeviceProfileURL) String() string {
...
func (o *GetV1DevicesDeviceProfileURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetV1DevicesDeviceProfileURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetV1DevicesDeviceProfileURL")
	}
