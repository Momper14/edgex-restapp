...
// NewGetV1DevicesDeviceParams creates a new GetV1DevicesDeviceParams object
// no default values defined in spec.
func NewGetV1DevicesDeviceParams() GetV1DevicesDeviceParams {

	return GetV1DevicesDeviceParams{}
}

// GetV1DevicesDeviceParams contains all the bound params for the get v1 devices device operation
...
func (o *GetV1DevicesDeviceParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetV1DevicesDeviceParams) bindDevice(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
