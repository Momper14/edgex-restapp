...
func (o *GetV1AdminUsersUserURL) WithBasePath(bp string) *GetV1AdminUsersUserURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetV1AdminUsersUserURL) Build() (*url.URL, error) {
	...
	if user != "" {
		...
		return nil, errors.New("user is required on GetV1AdminUsersUserURL")
	}
...
func (o *GetV1AdminUsersUserURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetV1AdminUsersUserURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetV1AdminUsersUserURL")
	}
