...
func (o *GetV1AdminRolesRoleUsersURL) WithBasePath(bp string) *GetV1AdminRolesRoleUsersURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetV1AdminRolesRoleUsersURL) Build() (*url.URL, error) {
	...
	var _path = "/v1/admin/roles/{role}/users"

	role := o.Role
	if role != "" {
		_path = strings.Replace(_path, "{role}", role, -1)
	} else {
		return nil, errors.New("role is required on GetV1AdminRolesRoleUsersURL")
	}
...
func (o *GetV1AdminRolesRoleUsersURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetV1AdminRolesRoleUsersURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetV1AdminRolesRoleUsersURL")
	}
