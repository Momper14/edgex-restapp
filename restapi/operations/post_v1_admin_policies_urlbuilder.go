...
func (o *PostV1AdminPoliciesURL) WithBasePath(bp string) *PostV1AdminPoliciesURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *PostV1AdminPoliciesURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PostV1AdminPoliciesURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PostV1AdminPoliciesURL")
	}
