...
func (o *DeleteV1AdminPoliciesURL) WithBasePath(bp string) *DeleteV1AdminPoliciesURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *DeleteV1AdminPoliciesURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteV1AdminPoliciesURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteV1AdminPoliciesURL")
	}
